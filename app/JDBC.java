...
public class JDBC {
    ...
    private static final String PASSWORD = "diwash12345";
    ...
    public static ReturnType checkLogin(String email, String password) {
        String query = "SELECT * FROM users WHERE email = ?";
                
        try (Connection connection = getConnection()) {
            if (connection == null) {
                return new ReturnType(false, "Unable to connect to database", null);
            }
            ...
            try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                ...
                if (response.next()) {
                    ...
                    if (verified) {
                        return new ReturnType(true, "Login Successful", 
                               new Compitetor(id, name, email, role, level, scores));
                    } else {
                        return new ReturnType(false, "Incorrect password for email: " + email, null);
                    }
                } else {    
                    return new ReturnType(false, "No User found with the provided credentials", null);
                }
            }
        } catch (SQLException exception) {
            System.out.println(exception);
            return new ReturnType(false, "Server side exception occurred", null);
        }
    }
	
	
    public static ReturnType registerUser(String name, String email, String password, String level) {
        ReturnType response = validEmail(email);
        if(response.success) {
            ...
            try (Connection connection =getConnection()) {
                ...
                try (PreparedStatement preparedStatement = connection.prepareStatement(query, Statement.RETURN_GENERATED_KEYS)) {
                    ...
                    if (affectedRows > 0) {
                        return new ReturnType(true, "User: " + name.toUpperCase() + " created successfully", null);
                    }
                    return new ReturnType(false, "User creation failed", null);
                }
            } catch (SQLException exception) {
                System.out.println(exception);
                return new ReturnType(false, "Server Side exception occurred", null);
        ...
        return new ReturnType(false, "User with this email already exists", null);
    }
	
    public static ReturnType validEmail(String email) {
        ...
        try (Connection connection = getConnection()) {
            ...
            try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                ...
                if (resultSet.next()) {
                    return new ReturnType(false, "User with the email " + email + " already exists", null);
                } else {
                    return new ReturnType(true, "Success", null);
                }
            }
        } catch (SQLException exception) {
            System.out.println(exception);
    ...
    public static ReturnType addQuestion(String question, String level, String answer, 
        ...
        try (Connection connection = getConnection()) {
            ...
            try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                ...
                int affectedRows = preparedStatement.executeUpdate();
                if (affectedRows > 0) {
                    return new ReturnType(true, "Question Addition Successful", null);
                } else {
                    return new ReturnType(false, "Question Addition Failed", null);
                }
            }
        } catch (SQLException exception) {
            System.out.println(exception);
    ...
    public static ReturnType getUserByEmail(String email) {
        ...
        try (Connection connection = getConnection()) {
            ...
            try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                ...
                if (rs.next()) {
                    ...
                    return new ReturnType(true, "User Found!", user);
                } else {
                    return new ReturnType(false, "No user found with this email", null);
                }
            }
        } catch (SQLException exception) {
            System.out.println(exception);
    ...
    public static ReturnType getAllUsers() {
        ...
        try (Connection connection = getConnection()) {
            ...
            try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                ...
                if (rs.next()) {
                    ...
                    return new ReturnType(false, "No users found", null);
                }
            }
        } catch (SQLException exception) {
            System.out.println(exception);
