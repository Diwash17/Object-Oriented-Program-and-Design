...
class QuestionsTest {
    ...
    @BeforeEach
    void setUp() {
        question = new Questions(1, "What is Python?", "Programming Language", "Snake", "Car", "Football", "Easy", "Programming Language");
    }
    ...
    void testGetQuestionText() {
        assertEquals("What is Python?", question.getQuestionText());
    }
